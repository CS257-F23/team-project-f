...
class TestFeatures(unittest.TestCase):  
    ...
    def test_case_justice_votes_1(self):
        ...
        expected_list = [('HHBurton', '2'), ('RHJackson', '1'), ('WODouglas', '1'), ('FFrankfurter', '4'), ('SFReed', '1'), ('HLBlack', '1'), ('WBRutledge', '1'), ('FMurphy', '1'), ('FMVinson', '1')]
    ...
    def test_case_justice_votes_2(self):
        ...
        expected_list = [('HHBurton', '1'), ('RHJackson', '1'), ('WODouglas', '1'), ('FFrankfurter', '1'), ('SFReed', '1'), ('HLBlack', '1'), ('WBRutledge', '1'), ('FMurphy', '1'), ('FMVinson', '1')]
        self.assertEqual(vote_list,expected_list)
